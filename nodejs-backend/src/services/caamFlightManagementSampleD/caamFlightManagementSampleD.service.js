const { CaamFlightManagementSampleD } = require("./caamFlightManagementSampleD.class");
const createModel = require("./caamFlightManagementSampleD.model");
const hooks = require("./caamFlightManagementSampleD.hooks");
...
module.exports = function (app) {
  ...
  app.use("/caamFlightManagementSampleD", new CaamFlightManagementSampleD(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("caamFlightManagementSampleD");

  // Get the schema of the collections 
  app.get("/caamFlightManagementSampleDSchema", function (request, response) {
