...
fuelOnBoardKg: { type: Number, comment: "Fuel On Board Kg, knob, false, true, true, true, true, true, true, , , , ," },
status: { type: [String] , comment: "Status, chip, false, true, true, true, true, true, true, , , , ," },
