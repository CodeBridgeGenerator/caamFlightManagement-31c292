...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="fuelOnBoardKg" value={_entity?.fuelOnBoardKg} min={0} max={100} onChange={ (e) => setValByKey("fuelOnBoardKg", e.value)}  useGrouping={false} />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Chips id="status" className="w-full mb-3" value={_entity?.status} onChange={(e) => setValByKey("status", e.target.value)}  />
            </span>
            <small className="p-error">
