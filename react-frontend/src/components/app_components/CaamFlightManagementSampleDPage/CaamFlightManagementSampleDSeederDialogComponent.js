...
import seederData from "./caamFlightManagementSampleD.seeder.json";
...
const CaamFlightManagementSampleDSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CaamFlightManagementSampleDSeederDialogComponent);
